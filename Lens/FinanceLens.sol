...
interface FinancetrollerLensInterface {
    ...
    function getFinanceAddress() external view returns (address);
...
contract FinanceLens {
    ...
    function pendingRewards(
        ...
        rewardSummary.rewardTokenAddress = financetroller.getFinanceAddress();
       
        FinanceBalanceMetadataExt memory financeMetadata = this.getFinanceBalanceMetadataExt(FinanceInterface(address(financetroller.getFinanceAddress())), financetroller, holder);
